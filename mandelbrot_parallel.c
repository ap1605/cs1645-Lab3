...
int main() {
    ...
    #   pragma omp parallel num_threads(thread_count) default(none) \
        shared(dx, dy, totalSum, pixels, avg, chunksize) private(i, j, count, x, y, x0, y0, tempx)
        {
            ...
            #   pragma omp for reduction(+: totalSum) schedule(dynamic, 5) nowait
